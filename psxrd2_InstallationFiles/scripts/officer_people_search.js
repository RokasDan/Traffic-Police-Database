// javascript used in the page of offender search.
...
window.onload = function () {
    ...
    function login(search, name, onSuccess, onError) {
        ...
        request.open('post', '../php/officer_people_search.php', true)
    ...
    function handleSuccess(search, results) {
        sessionStorage.setItem("people", search);
        sessionStorage.setItem("numberResults", results);
        window.location.href = "officer_people_results.html";
    }
