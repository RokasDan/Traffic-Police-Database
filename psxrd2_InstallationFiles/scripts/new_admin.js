// javascript for creating new admin for the database.
...
window.onload = function () {
    ...
    function Admin(username, password, onSuccess, onError) {
        ...
        request.open('post', '../php/new_admin.php', true)
    ...
    function newAdmin(event) {
        ...
        Admin(username, password, handleSuccess, handleError)
    }

    // Making an event listener which will wait for a form submit from the html page
    // and will do the newAdmin function upon receiving one.
    form.addEventListener('submit', newAdmin)
}