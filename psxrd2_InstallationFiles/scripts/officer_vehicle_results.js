// javascript for showing the vehicle results found with in report search.

// code actives once the page is full loaded where the code is referenced.
window.onload = function () {

    // Getting the values of the vehicle search stored in the session storage.
    const name = sessionStorage.getItem('officer');
    const search = sessionStorage.getItem('cars');
