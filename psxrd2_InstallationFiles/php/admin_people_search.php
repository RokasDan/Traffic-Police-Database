        ...
        if (mysqli_num_rows($result) == 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $searchResults .= "<div class='rect19'>
                                        <div class='container8'><h9 class='header13'>" . $row['people_id'] . "</h9></div>
                                        <div class='container9'><h6 class='header13'>" . $row['first_name'] . "</h6></div>
                                        <div class='container10'><h7 class='header13'>" . $row['last_name'] . "</h7></div>
                                        <div class='container11'><h8 class='header13'>" . $row['license_number'] . "</h8></div>
                                        <div class='container12'><a class='button50' href='Apeople_results.html?people=" . $row['people_id'] . "'>VIEW</a></div>
                                   </div>";
