                    ...
                    while ($row = mysqli_fetch_assoc($result2)) {
                        ...
                        $searchResults .= "<nobr><div class='container49'><h1 class='header4'>THE INCIDENT</h1></div></nobr>
                                ...
                                <div class='container53'>
                                    ...
                                    <div class='container60'><a class='button28' href='officer_update_rdate.html?update=" . $row['report_id'] . "'>#</a><nobr><h1 class='header4'>|DATE|</h1></nobr></div>
                                    <div class='container61'><nobr><h1 class='header4'>" . $row['report_date'] . "</h1></nobr></div>
                                    <div class='container62'><nobr><h1 class='header4'>|FINE|</h1></nobr></div>
                                    <div class='container63'><nobr><h1 class='header4'>" . $row['fine_issued'] . "</h1></nobr></div>
                                    <div class='container64'><nobr><h1 class='header4'>|POINTS|</h1></nobr></div>
                                    <div class='container68'><nobr><h1 class='header4'>" . $row['points_issued'] . "</h1></nobr></div>
                                    <div class='container69'><a class='button28' href='officer_update_offence.html?update=" . $row['report_id'] . "'>#</a><nobr><h1 class='header4'>|OFFENCE_ID|</h1></nobr></div>
                                    ...
                                    <div class='container73'><a class='button28' href='officer_update_report.html?update=" . $row['report_id'] . "'>#</a><nobr><h1 class='header4'>|REPORT|</h1></nobr></div>
