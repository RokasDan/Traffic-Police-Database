            ...
            if (mysqli_num_rows($result1) == 0){
                ...
                if (mysqli_num_rows($result2) == 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result2)) {
                        ...
                        $searchResults .= "<div class='rect12'>
                                        <div class='container8'><h9 class='header3'>" . $row['report_id'] . "</h9></div>
                                        <div class='container43'><h6 class='header3'>" . $row['first_name'] . "</h6></div>
                                        <div class='container44'><h7 class='header3'>" . $row['license_number'] . "</h7></div>
                                        <div class='container45'><h8 class='header3'>" . $row['number_plate'] . "</h8></div>
                                        <nobr><div class='container46'><h8 class='header3'>" . $row['report_date'] . "</h8></div></nobr>
                                        <div class='container47'><a class='button13' href='report_results.html?reports=" . $row['report_id'] . "'>VIEW</a></div>
                                   </div>";
