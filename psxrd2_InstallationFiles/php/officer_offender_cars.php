        ...
        if (mysqli_num_rows($result) == 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $searchResults .= "<div class='rect9'>
                                        <div class='container8'><h9 class='header3'>" . $row['number_plate'] . "</h9></div>
                                        <div class='container9'><h6 class='header3'>" . $row['brand'] . "</h6></div>
                                        <div class='container10'><h7 class='header3'>" . $row['colour'] . "</h7></div>
                                        <div class='container11'><h8 class='header3'>" . $row['first_name'] . "</h8></div>
                                        <div class='container12'><a class='button13' href='officer_offender_vehicle_details.html?cars=" . $row['number_plate'] . "'>VIEW</a></div>
                                   </div>";
            }
