        ...
        if (mysqli_num_rows($result) == 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $searchResults .= "<div class='rect19'>
                                        <div class='container13'><h9 class='header13'>" . $row['Offence_ID'] . "</h9></div>
                                        <div class='container14'><h6 class='header13'>" . $row['description'] . "</h6></div>
                                        <div class='container15'><a class='button50' href='Aoffence_details.html?details=" . $row['Offence_ID'] . "'>VIEW</a></div>
                                   </div>";
